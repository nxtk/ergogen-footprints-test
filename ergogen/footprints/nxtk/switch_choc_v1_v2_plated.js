...
module.exports = {
  ...
  (footprint "ceoloide:switch_choc_v1_v2"
    ...
    ${'' /* Middle Hole */}
    (pad ${(p.plated && !p.reversible) ? p.side == 'B' ? 1 : 2 : '""'} ${p.plated ? 'thru_hole' : 'np_thru_hole'} circle (at 0 -5.95 ${p.r}) (size ${p.plated ? '3.3 3.3' : '3 3'}) (drill 3) (layers "*.Cu" "*.Mask") ${(p.plated && !p.reversible) ? p.side == 'B' ? p.from.str : p.to.str : ''})
    `
    ...
    const hotswap_front_pad_plated_cutoff = `
    (pad "1" smd rect (at -6.55 -3.75 ${p.r}) (size 1.2 2.15) (layers "F.Cu") ${p.from.str})
    (pad "2" smd roundrect (at 3.245 -5.95 ${p.r}) (size 2.65 2.15) (layers "F.Cu" "F.Paste" "F.Mask") (roundrect_rratio 0.1) ${p.to.str})
    `
    const hotswap_front_pad_plated_full = `
    (pad "2" smd rect (at 1.55 -5.95 ${p.r}) (size 1.2 2.15) (layers "F.Cu") ${p.to.str})
    (pad "2" smd roundrect (at 3.245 -5.95 ${p.r}) (size 2.65 2.15) (layers "F.Cu" "F.Paste" "F.Mask") (roundrect_rratio 0.1) ${p.to.str})
    (pad "1" smd rect (at -6.55 -3.75 ${p.r}) (size 1.2 2.15) (layers "F.Cu") ${p.from.str})
    `
    ...
    `
    const hotswap_back_pad_plated_cutoff = `
    (pad "1" smd roundrect (at -3.245 -5.95 ${p.r}) (size 2.65 2.15) (layers "B.Cu" "B.Paste" "B.Mask") (roundrect_rratio 0.1) ${p.from.str})
    (pad "2" smd rect (at 6.55 -3.75 ${p.r}) (size 1.2 2.15) (layers "B.Cu") ${p.to.str})
    `
    
    const hotswap_back_pad_plated_full = `
    (pad "1" smd rect (at -1.55 -5.95 ${p.r}) (size 1.2 2.15) (layers "B.Cu") ${p.from.str})
    (pad "1" smd roundrect (at -3.245 -5.95 ${p.r}) (size 2.65 2.15) (layers "B.Cu" "B.Paste" "B.Mask") (roundrect_rratio 0.1) ${p.from.str})
    (pad "2" smd rect (at 6.55 -3.75 ${p.r}) (size 1.2 2.15) (layers "B.Cu") ${p.to.str})
    `
    ...
    ${'' /* Left Pad*/}
    ${p.plated ? p.reversible ? hotswap_back_pad_plated_cutoff
                              : hotswap_back_pad_plated_full
               : p.reversible ? hotswap_back_pad_cutoff
                              : hotswap_back_pad_full}

    ${'' /* Right Pad (not cut off) */}
    ${p.plated ? `(pad "2" smd roundrect (at ${8.245 - (2.6 - p.outer_pad_width_back) / 2} -3.75 ${p.r}) (size ${p.outer_pad_width_back} 2.15) (layers "B.Cu" "B.Paste" "B.Mask") (roundrect_rratio 0.1) ${p.to.str})`
    ...
    ${'' /* Side Hole */}
    (pad ${p.plated ? `"2" thru_hole` : `"" np_thru_hole`} circle (at 5 -3.75 ${195 + p.r}) (size ${p.plated ? '3.3 3.3' : '3 3'}) (drill 3) (layers "*.Cu" "*.Mask") ${p.to.str})
    `
    ...
    ${'' /* Right Pad (cut off) */}
    ${p.plated ? p.reversible ? hotswap_front_pad_plated_cutoff
                              : hotswap_front_pad_plated_full
               : p.reversible ? hotswap_front_pad_cutoff
                              : hotswap_front_pad_full}

    ${'' /* Left Pad (not cut off) */}
    ${p.plated ? `(pad "1" smd roundrect (at ${-8.245 + (2.6 - p.outer_pad_width_front) / 2} -3.75 ${p.r}) (size ${p.outer_pad_width_front} 2.15) (layers "F.Cu" "F.Paste" "F.Mask") (roundrect_rratio 0.1) ${p.from.str})`
    ...
    ${'' /* Side Hole */}
    (pad ${p.plated ? `"1" thru_hole` : `"" np_thru_hole`} circle (at -5 -3.75 ${195 + p.r}) (size ${p.plated ? '3.3 3.3' : '3 3'}) (drill 3) (layers "*.Cu" "*.Mask") ${p.from.str})
    `
